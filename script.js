...
// Show loading screen immediately (before DOM loads)
document.addEventListener('DOMContentLoaded', function() {
    const loadingScreen = document.getElementById('urbanstitch-loading-screen');
    if (loadingScreen) {
        console.log('Loading screen found, initializing...');
        
        // Force show the loading screen
        loadingScreen.style.display = 'flex';
        loadingScreen.style.opacity = '1';
        loadingScreen.style.visibility = 'visible';
        document.body.style.overflow = 'hidden';
        
        // Hide loading screen after minimum time and when everything is loaded
