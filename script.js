...
// ==========================================
// LOADING SCREEN CONTROLLER - ADD AT END OF script.js
// ==========================================

class LoadingScreenController {
    constructor() {
        this.loadingScreen = null;
        this.minDisplayTime = 1000; // Minimum 1 second display
        this.startTime = Date.now();
        this.init();
    }

    init() {
        this.loadingScreen = document.getElementById('urbanstitch-loading-screen');
...
// Expose to global UrbanStitch object
if (window.UrbanStitch) {
    window.UrbanStitch.loadingController = loadingController;
}